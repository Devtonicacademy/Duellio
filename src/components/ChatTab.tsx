...
export const ChatTab: React.FC<ChatTabProps> = ({
  ...
  const [challengeGame, setChallengeGame] = useState<'Chess' | 'Ludo' | 'Whot' | 'Draft'>('Chess');
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-4 gap-1.5 p-1 bg-black/40 border border-white/[0.04] rounded-xl">
