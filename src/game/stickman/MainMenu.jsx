...
const mapDescriptions = {
  ...
  neon_rooftop:    { text: 'A high-rise rooftop shimmering with skyline and electric drones.', hazard: '≡ƒ¢╕ Cyber Drones' },
  zen_garden:      { text: 'A bamboo garden with calm stones, petals, and wind gusts.',    hazard: '≡ƒÆ¿ Wind Gusts' },
  magma_cavern:    { text: 'A molten cavern filled with fire, smoke, and raw heat.',        hazard: '≡ƒöÑ Lava Spouts' },
  stormy_temple:   { text: 'A storm-lashed temple pulsing with thunder and rain.',          hazard: 'ΓÜí Lightning Strikes' },
};
    ...
    <div className={`main-menu-container ${isFullscreen ? 'fullscreen-active' : ''}`}>
      <div className="main-menu">
        ...
        <div className="menu-header">
          <div className="menu-badge">ΓÜö∩╕Å</div>
          <div>
          ...
          <div className="menu-panel menu-panel-secondary">
            ...
            {gameMode === 'practice' && (
              <div className="practice-info-panel">
                <p className="practice-info-title">≡ƒÑï Practice Dojo Features</p>
                <ul className="practice-info-list">
                  <li>ΓÖ╛∩╕Å Infinite health (both fighters)</li>
                  <li>≡ƒâÅ Input log shown on screen</li>
                  <li>≡ƒñû Dummy stands still by default</li>
                  <li>ΓÅ▒∩╕Å No round timer</li>
                </ul>
              </div>
            )}
            ...
            {gameMode === 'survival' && (
              <div className="survival-info-panel">
                <p className="survival-info-title">≡ƒîè Survival Mode</p>
                <ul className="survival-info-list">
                  <li>Γ¼å∩╕Å CPU gets harder each wave</li>
                  <li>Γ¥ñ∩╕Å +30 HP restored after each win</li>
                  <li>≡ƒù║∩╕Å Random arena each wave</li>
                  <li>≡ƒÅå High score saved locally</li>
                </ul>
              </div>
            )}
          </div>
