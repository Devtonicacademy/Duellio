          ...
          <div className="flex flex-col animate-fade-in glassmorphic border border-zinc-800/50 shadow-2xl rounded-2xl p-6 backdrop-blur-md bg-zinc-950/40 text-white">
            ...
            <div className="max-h-96 overflow-y-auto pr-2 flex flex-col gap-4 text-xs">
              ...
              <div className="bg-pink-950/40 border border-pink-500/30 rounded-lg p-3">
                ...
                <div className="flex flex-col gap-1.5 text-zinc-300 text-[10px]">
                  <div><kbd className="bg-zinc-800 px-1.5 py-0.5 rounded border border-zinc-700 font-mono text-[9px]">ΓåæΓåôΓåÉΓåÆ</kbd> = Move | <kbd className="bg-zinc-800 px-1.5 py-0.5 rounded border border-zinc-700 font-mono text-[9px]">Num 1</kbd> = Punch</div>
              ...
              <div className="bg-purple-950/40 border border-purple-500/30 rounded-lg p-3 text-zinc-300">
                <div className="font-bold text-purple-300 mb-1">≡ƒÆí Tips:</div>
                <ul className="space-y-0.5 text-[9px] ml-2">
                  <li>ΓÇó Combine directions with attacks for special moves</li>
                  <li>ΓÇó Build combos to unlock devastating finishers</li>
                  <li>ΓÇó Chi meter charges with blocks and hits</li>
                  <li>ΓÇó Touch controls auto-enable on mobile devices</li>
                </ul>
              </div>
            </div>
